...
$(function() {
  ...
  (function(a) {
    ...
    function c(a, b) {
      for (
        var c = Array.prototype.slice.call(arguments).splice(2),
          d = a.split("."),
          e = d.pop(),
          f = 0;
        f < d.length;
    ...
    var d = [],
              ...
              a(i).bind("submit", function(b) {
                ...
                f
                  ...
                  f.each(function(b, c) {
                    ...
                    f.hasClass("warning") &&
                      (f.removeClass("warning").addClass("error"), e++);
                  }),
                  f.trigger("validationLostFocus.validation"),
                  e
                    ? (c.options.preventSubmit && b.preventDefault(),
                      d.addClass("error"),
                      a.isFunction(c.options.submitError) &&
                        c.options.submitError(
                          d,
                          b,
                          f.jqBootstrapValidation("collectErrors", !0)
                        ))
                    : (d.removeClass("error"),
                      a.isFunction(c.options.submitSuccess) &&
                ...
                if (
                  ...
                  if (
                    (void 0 !== b.attr("pattern") &&
                      ...
                      b.data("validationPatternMessage") &&
                        (k = b.data("validationPatternMessage")),
                      b.data("validationPatternMessage", k),
                  ...
                  void 0 !== b.attr("maxlength") &&
                    ...
                    b.data("validationMaxlengthMessage") &&
                      (k = b.data("validationMaxlengthMessage")),
                    b.data("validationMaxlengthMessage", k),
                    b.data(
                    ...
                    void 0 !== b.attr("minlength") &&
                      ...
                      b.data("validationMinlengthMessage") &&
                        (k = b.data("validationMinlengthMessage")),
                      b.data("validationMinlengthMessage", k),
                      b.data(
                    ...
                    (void 0 === b.attr("required") &&
                      ...
                      ((k = c.builtInValidators.required.message),
                      b.data("validationRequiredMessage") &&
                        (k = b.data("validationRequiredMessage")),
                      b.data("validationRequiredMessage", k)),
                    void 0 !== b.attr("type") &&
                      "number" === b.attr("type").toLowerCase() &&
                      ((k = c.builtInValidators.number.message),
                      b.data("validationNumberMessage") &&
                        (k = b.data("validationNumberMessage")),
                      b.data("validationNumberMessage", k)),
                    void 0 !== b.attr("type") &&
                      ...
                      b.data("validationValidemailMessage")
                        ? (k = b.data("validationValidemailMessage"))
                        : b.data("validationEmailMessage") &&
                          (k = b.data("validationEmailMessage")),
                      b.data("validationValidemailMessage", k)),
                    void 0 !== b.attr("minchecked") &&
                      ...
                      b.data("validationMincheckedMessage") &&
                        (k = b.data("validationMincheckedMessage")),
                      b.data("validationMincheckedMessage", k),
                      b.data(
                    ...
                    void 0 !== b.attr("maxchecked") &&
                      ...
                      b.data("validationMaxcheckedMessage") &&
                        (k = b.data("validationMaxcheckedMessage")),
                      b.data("validationMaxcheckedMessage", k),
                      b.data(
                  ...
                  a.each(j, function(a, b) {
                    ...
                    a.each(n, function(d, e) {
                      if (void 0 !== b.data("validation" + e + "Shortcut"))
                        a.each(
                          b.data("validation" + e + "Shortcut").split(","),
                          function(a, b) {
                            o.push(b);
                          }
                        );
                        ...
                        "shortcut" === g.type.toLowerCase() &&
                          a.each(g.shortcut.split(","), function(a, b) {
                ...
                a.each(j, function(d, e) {
                  ...
                  if (
                    ...
                    a.each(c.validatorTypes, function(c, d) {
                      void 0 === p[c] && (p[c] = []),
                        i ||
                          void 0 === b.data("validation" + e + f(d.name)) ||
                          (p[c].push(
                            a.extend(
                              !0,
                              { name: f(d.name), message: g },
                              d.init(b, e)
                            )
                          ),
                          (i = !0));
                      ...
                      : a.each(c.validatorTypes, function(c, d) {
                          void 0 === p[c] && (p[c] = []),
                            i ||
                              k !== c.toLowerCase() ||
                              (b.data(
                                "validation" + e + f(d.name),
                                j[d.name.toLowerCase()]
                              ),
                              p[k].push(a.extend(j, d.init(b, e))),
                              (i = !0));
                        });
                  }
                  ...
                  h.data(
                    "original-contents",
                    h.data("original-contents")
                      ? h.data("original-contents")
                      : h.html()
                  ),
                  h.data(
                    "original-role",
                    h.data("original-role")
                      ? h.data("original-role")
                      : h.attr("role")
                  ),
                  e.data(
                    "original-classes",
                    e.data("original-clases")
                      ? e.data("original-classes")
                      : e.attr("class")
                  ),
                  b.data(
                  ...
                  b.bind("validation.validation", function(d, e) {
                    var f = g(b),
                      h = [];
                    return (
                      a.each(p, function(d, g) {
                        (f ||
                          f.length ||
                          (e && e.includeEmpty) ||
                          (c.validatorTypes[d].blockSubmit &&
                            e &&
                            e.submitting)) &&
                          a.each(g, function(a, e) {
                            c.validatorTypes[d].validate(b, f, e) &&
                              h.push(e.message);
                          });
                      }),
                      h
                  ...
                  b.bind(
                    ...
                    function(d, f) {
                      ...
                      e.find("input,textarea,select").each(function(c, d) {
                        ...
                        if (
                          (a.each(
                            a(d).triggerHandler("validation.validation", f),
                            function(a, b) {
                              k.push(b);
                            }
                          ),
                        ...
                        (k = a.unique(k.sort())),
                        k.length
                          ? (e.removeClass("success error").addClass("warning"),
                            c.options.semanticallyStrict && 1 === k.length
                              ? h.html(
                                  k[0] +
                          ...
                          : (e.removeClass("warning error success"),
                            j.length > 0 && e.addClass("success"),
                            h.html(h.data("original-contents"))),
                        "blur" === d.type && e.removeClass("success");
                    }
                  ),
              ...
              this.each(function(c, d) {
                b = b.concat(
                  a(d).triggerHandler("getValidators.validation")
                    ? a(d).triggerHandler("validation.validation", {
                        submitting: !0
                      })
                    : []
                );
        ...
        validatorTypes: {
              ...
              if (!0 === d.lastFinished) {
                ...
                c(d.callback, window, a, b, function(a) {
                  e.lastValue === a.value &&
                    ...
                    (e.lastFinished = !0),
                    f.data(
                      "validation" + e.validatorName + "Message",
                      e.message
                    ),
                    setTimeout(function() {
          ...
          ajax: {
            ...
            validate: function(b, c, d) {
              return "" + d.lastValue == "" + c && !0 === d.lastFinished
                ? !1 === d.lastValid
                : (!0 === d.lastFinished &&
                    ((d.lastValue = c),
                    (d.lastValid = !0),
                    ...
                    a.ajax({
                      ...
                      success: function(a) {
                        "" + d.lastValue == "" + a.value &&
                          ...
                          (d.lastFinished = !0),
                          b.data(
                            "validation" + d.validatorName + "Message",
                            d.message
                          ),
                          setTimeout(function() {
          ...
          required: {
            ...
            validate: function(a, b, c) {
              return (
                !(0 !== b.length || c.negative) ||
                !!(b.length > 0 && c.negative)
              );
            },
            blockSubmit: !0
          },
          ...
          maxchecked: {
            ...
            validate: function(a, b, c) {
              return (
                (c.elements.filter(":checked").length > c.maxchecked &&
                  !c.negative) ||
                (c.elements.filter(":checked").length <= c.maxchecked &&
                  c.negative)
              );
          ...
          minchecked: {
            ...
            validate: function(a, b, c) {
              return (
                (c.elements.filter(":checked").length < c.minchecked &&
                  !c.negative) ||
                (c.elements.filter(":checked").length >= c.minchecked &&
                  c.negative)
              );
      ...
      g = function(b) {
        ...
        return (
          ...
          "radio" === d &&
            (c =
              a('input[name="' + b.attr("name") + '"]:checked').length > 0
                ? c
                : ""),
          c
        );
    ...
    (a.fn.jqBootstrapValidation = function(b) {
      return e.methods[b]
        ? e.methods[b].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof b && b
        ? (a.error(
  ...
  jQuery(document).ready(function(a) {
    if (a(window).width() > 1170) {
      ...
      a(window).on("scroll", { previousTop: 0 }, function() {
        ...
        c < this.previousTop
          ? c > 0 && a(".navbar-custom").hasClass("is-fixed")
